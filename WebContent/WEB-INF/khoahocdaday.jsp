...
<body id="myPage">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="Menu content">
					<ul class="list-group">
						...
						%>
						<sql:query dataSource="${data}" var="result">
         							select * from spgetcourseadmin where IDTeacher=?;
			...
			<div class="col-sm-9">
				...
				<div class="text-center">
					<div class="titleInfo title">KHÓA HỌC ĐÃ DẠY</div>
								...
								<div class="panel panel-default">
									...
									<div>
										<div class="panel-footer">
											...
											<a href="xemdanhsachlop?iddslh=${row.IDClass}">
		...
		<script type="text/javascript">
				$(function() {
					var pageSize = 6; // Hiển thị 6 khóa học trên 1 trang
