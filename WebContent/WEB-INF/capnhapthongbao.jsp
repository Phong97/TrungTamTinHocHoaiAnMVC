		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<%
					...
					session.setAttribute("idannounce", idannounce);
			...
			<div class="col-sm-3">
				...
				<div class="Menu content">
					<ul class="list-group">
						...
						<li id="list-one" class="list-group-item"><a href="quanlythongbao">Quản lý thông báo</a></li>
					</ul>
				</div>
			</div>
				...
				<sql:query dataSource="${data}" var="result">
	         		...
	         		<sql:param value="${idannounce}" />
				</sql:query>

			<div class="inform col-sm-9">
				<div class="titleInfo title">Cập nhập thông báo</div>
				...
				<div>
					<c:if test="${thongbao eq 0}">
					  	<p id="announce2">Cập nhật thông báo không thành công!</p>
					</c:if>
				</div>
				
				<c:forEach var="row" items="${result.rows}">
					<form action="capnhapthongbao" method="post" enctype="multipart/form-data">
						<div class="col-sm-2">
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input id="tieude" type="text" class="form-control content_input"
									placeholder="Tiêu đề" aria-describedby="basic-addon"
									value="${row.Title}" name="tieude" required>
							</div>
						</div>
						<div class="khoangcach">
							<br> <br>
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input id="description" type="text" class="form-control content_input"
									placeholder="Tóm tắt nội dung" aria-describedby="basic-addon"
									value="${row.Description}" name="description" required>
							</div>
						</div>
						<div class="khoangcach">
							<br> <br>
						...
						<div class="khoangcach">
						 ...
						 <br>
						<textarea name="noidung">${row.Content_Announce}</textarea>
						<div class="khoangcach">
							<br> <br>
						</div>
						 <br>
