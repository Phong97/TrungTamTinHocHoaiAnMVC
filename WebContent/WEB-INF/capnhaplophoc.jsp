		...
		<div class="row">
			<div class="col-sm-3">
				...
				<sql:query dataSource="${data}" var="result">
	         		...
	         		<sql:param value="${idclass}" />
				</sql:query>

			<div class="inform col-sm-9">
				<div class="titleInfo title">Cập nhập lớp học</div>
				...
				<div>
					<c:if test="${thongbao eq 0}">
					  	<p id="announce2">Cập nhập lớp học không thành công!</p>
					</c:if>						
				</div>
				
				<c:forEach var="row" items="${result.rows}">
					<form action="capnhaplophoc" method="post">
						<div class="col-sm-2">
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input name="lichhoc" type="text" class="form-control content_input"
									value="${row.TimeStudy}" placeholder="Lịch học" aria-describedby="basic-addon" required>
							</div>
						</div>
						<div class="khoangcach">
							<br> <br>
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input id="soluong" name="soluong" type="text" class="form-control content_input"
									value="${row.Limited}" placeholder="Số Lượng" aria-describedby="basic-addon" required>
							</div>
						</div>
						<div class="khoangcach">
							<br> <br>
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input name="baigiang" type="text" class="form-control content_input"
									value="${row.Link}" placeholder="Link bài giảng" aria-describedby="basic-addon" required>
							</div>
						</div>
						<div class="khoangcach">
							<br> <br>
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input name="ngaykhaigiang" type="text"
									...
									value="${row.Start}" aria-describedby="basic-addon" required>
							</div>
						</div>
						<div class="khoangcach">
							<br> <br>
							...
							<div class="input-group">
								...
								<select class="form-control" name="giaovien" required>
									...
									<c:forEach var="row1" items="${result1.rows}">
										<option value="${row1.IDUser}">${row1.Name}</option>		
									</c:forEach>
									...
									<c:forEach var="row2" items="${result2.rows}">
										<option value="${row2.IDUser}">${row2.Name}</option>		
									</c:forEach>
